...
if (favourite_fruits.includes("orange")) {
    console.log("I donot like orange");
}
...
let userName = ['Admin', 'khadija', 'Ammara', 'aiza', 'shagufta'];
// Ques:31
// No Users: Add an if test to Exercise 28 to make sure the list of users is not empty.
// • If the list is empty, print the message We need to find some users!
// • Remove all of the usernames from your array, and make sure the correct message is printed.
let user_Name = ['Admin', 'khadija', 'Ammara', 'aiza', 'shagufta'];
user_Name = [];
...
let current_users = ["humza", "areeba", "fahad", "zain", "saad"];
let new_users = ["khizar", "ramsha", "areeba", "fahad", "zain"];
new_users.forEach(new_one_users => {
    ...
    if (our_condition) {
        ...
        {
            console.log(`${new_one_users}  is  available`);
        }
    }
});
// QUES:33
...
let favourite_pizza = ["fajita", "red shawarma", "malai tikka"];
...
let magician_name = ["harrypotter", "Harry Houdini", "David Copperfield"];
...
let magicianName = ["harrypotter", "Harry Houdini", "David Copperfield"];
...
let magicianName1 = ["harrypotter", "Harry Houdini", "David Copperfield"];
